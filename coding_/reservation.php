<?php include('head.php'); ?>
	...
	<div id="contents" class="reservation">
		<div class="kv-same">
  		<img class="pc" src="./images/pic-reservation-kv.png" alt="予約">
  		<img class="sp" src="./images/pic-reservation-kv-sp.png" alt="予約">
  	</div>
		<img src="./images/icon-same.png" alt="アイコン" class="icon-same pc">
		<img src="./images/txt-reservation-caption.png" alt="お風呂" class="caption pc">
		...
		<div class="reservation-inner reservation-inner-color">
			...
			<div class="reservation-btn-area clearfix">
				<ul>
					<li><a href="#"><img src="./images/btn-reservation-apply.png" alt="お申し込み"></a></li>
					<li><a href="#"><img src="./images/btn-reservation-cofirm.png" alt="確認・キャンセル"></a></li>
				</ul>
			</div>
		</div>
